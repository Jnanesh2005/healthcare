...
SECRET_KEY = 'django-insecure-#pa+s3&xdl2a*-2=)1i=k$e=z)%572c_ss0sd0c0we&z+a4r-p'
...
EMAIL_HOST_PASSWORD = 'cxeq iawg ovsi whlv'  # NOT your Gmail password
...
ALLOWED_HOSTS = [
    'healthcare-2-u00n.onrender.com',  # your Render app domain
    'localhost', 
    '127.0.0.1'
]
